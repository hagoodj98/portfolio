    ...
    return (
        <main>
            <div className="tw-mb-30">
              <div className="tw--z-40 tw-relative tw-w-full tw-border-2 tw-bg-gradient-to-b tw-h-80 tw-from-moreblue tw-to-bluegreen">
              </div>
              <div className="tw-container tw-mx-auto tw--mt-36">
                  ...
                  <div className="tw-p-6 ">
                    <div className="tw-mx-auto md:tw-w-1/2 tw-flex tw-flex-col tw-items-center">
                      <h1 className="tw-text-6xl  lg:tw-text-7xl tw-text-bluegreen">My Portfilio</h1>
